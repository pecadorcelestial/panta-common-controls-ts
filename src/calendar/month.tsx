...
const MonthYearButton: AnyStyledComponent<HTMLProps<HTMLButtonElement>, any> = styled.button`
...
const Row: AnyStyledComponent<HTMLProps<HTMLDivElement>, any> = styled.div`
    display: flex;
    height: auto;
...
const WeekDayName: AnyStyledComponent<HTMLProps<HTMLLabelElement>, any> = styled.label`
    box-sizing: border-box;
    color: ${headerFontColor};
    font-family: "Open Sans", sans-serif;
    font-size: 12px;
...
const Day: AnyStyledComponent<IDayProps & HTMLProps<HTMLButtonElement>, any> = styled.button`
    border: none;
    border-radius: 50%;
    box-sizing: border-box;
    cursor: pointer;
