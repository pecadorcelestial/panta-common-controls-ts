...
export default class Years extends React.Component<IYearsProps, IYearsState> {
    //*** CONSTRUCTOR ***
    constructor(props: IYearsProps & React.HTMLProps<HTMLDivElement>) {
        super(props);
...
const Year: StyledComponent<'button', any, IYearProps & React.HTMLProps<HTMLButtonElement>, never> = styled.button`
    border: none;
    border-radius: 5px;
    box-sizing: border-box;
    cursor: pointer;
